...
public interface lab2Visitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link lab2Parser#addSub}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAddSub(lab2Parser.AddSubContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link lab2Parser#mulDiv}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMulDiv(lab2Parser.MulDivContext ctx);
	/**
